...
#         print(indx * cur_prime + (varvalue - indx*cur_prime) == varvalue)
#         varvalue = varvalue/cur_prime - varvalue%cur_prime
#    elif (indx % 2) == 1:

#         spotter = indx*cur_prime
#         if spotter > varvalue:
#             codeout = f"""
#         if count == {indx+1}
#             {varname} = {varname} + {indx}*cur_prime - {indx*cur_prime-varvalue}
# """
#             print(indx*cur_prime-(indx*cur_prime-varvalue) == varvalue )
#         else:
#             codeout = f"""
#         if count == {indx+1}
#             {varname} = {varname} + {indx}*cur_prime + {varvalue-indx*cur_prime}
# """

    #print(codeout)
    #tvars.append({"varname":varname, "finalvalue":ord(c), "code": codeout})
