...
# So, this is kinda dirty -- and yes, the tester script should probably live outside challenge repos# I imagine (hope!) there are smarter ways to do this, but right now this is what I have :(
...
$GIT remote add template "${1-git@github.com:o-o-overflow/dc2020q-template.git}" 2>/dev/null || true
